...
$(function () {
    ...
    var section = $('#section-block'),
        ...
        sectionBlockDataBody = $('.btn-section-block-databody'),
    ...
    if (sectionBlockCustom.length && section.length) {
        sectionBlockCustom.on('click', function () {
            section.block({
                message:
                    '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Lütfen Bekleyiniz...</p><div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
                timeout: 1000,
                css: {
                    backgroundColor: 'transparent',
                    color: '#fff',
    ...
    if (sectionBlockDataBody.length && dataBody.length) {
        sectionBlockDataBody.on('click', function () {
            dataBody.block({
                message:
                    '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Lütfen Bekleyiniz...</p><div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
                timeout: 1000,
